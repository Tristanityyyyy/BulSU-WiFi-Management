...
const TONES = {
  ...
  info: { Icon: Info, iconClass: "text-pink-500", barClass: "bg-pink-500" },
};
...
export default function Toast({ message, tone = "success", onDismiss, duration = 3500 }) {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[60] animate-toast-in max-w-sm">
      <div className="relative flex items-center gap-3 bg-white border border-slate-200 shadow-xl shadow-slate-300/40 rounded-2xl pl-4 pr-2 py-3 overflow-hidden">
